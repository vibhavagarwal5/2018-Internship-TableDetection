...
def SearchWithDistanceSF():
	...
	#T = pd.read_csv("/home/yasamin/Codes/WebTableAnnotation/data/T2D/t2d_tables_instance/1146722_1_7558140036342906956.csv") 
	#LabelColumn ="peak"
	search = pickle.load(open("/home/yasamin/Codes/WebTableAnnotation/data/surface/surfaceForms-20180820.pickle", "rb"))
	for k in search:
	...
	with open('/home/yasamin/Codes/WebTableAnnotation/data/surface/Surface_Lower_NoPunc.pickle', 'wb') as handle:
		pickle.dump(SFDict, handle)			
	


	#np.save("/home/yasamin/Codes/WebTableAnnotation/data/surface/searchNumpy.npy",search)
