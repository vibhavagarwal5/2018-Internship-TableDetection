...
def Multiprocess_Limaye():
    ...
    with open('/home/yasamin/Codes/WebTableAnnotation/data/LimayeTypes.pickle', 'wb') as handle:
        pickle.dump(InstanceOfDict, handle)
    #save dictionary of Levenshtein code to pickle file
    with open('/home/yasamin/Codes/WebTableAnnotation/data/LimayeLevenshtein.pickle', 'wb') as handle:
...
def Multiprocess_T2D():
    ...
    #save dictionary of label:instanceof to pickle file
    with open('/home/yasamin/Codes/WebTableAnnotation/data/T2DTypes.pickle', 'wb') as handle:
        pickle.dump(InstanceOfDict, handle)
    #save dictionary of Levenshtein code to pickle file
    with open('/home/yasamin/Codes/WebTableAnnotation/data/T2DLevenshtein.pickle', 'wb') as handle:
        pickle.dump(LevenshteinDict, handle)
